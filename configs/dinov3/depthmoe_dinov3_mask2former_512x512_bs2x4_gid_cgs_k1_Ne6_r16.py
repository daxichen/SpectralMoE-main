# dataset config
_base_ = [
    "../_base_/datasets/dg_gidcgs_512x512.py",
    "../_base_/default_runtime.py",
    "../_base_/models/depthmoe_dinov3_mask2former_gid_cgs.py"
]
train_pipeline = [
...
param_scheduler = [
    dict(type="PolyLR", eta_min=0, power=0.9, begin=0, end=66160, by_epoch=False)
]

# training schedule for 160k
train_cfg = dict(type="IterBasedTrainLoop", max_iters=66160, val_interval=3308)
...
default_hooks = dict(
    ...
    checkpoint=dict(
        type="CheckpointHook", by_epoch=False, interval=3308, max_keep_ckpts=10
    ),
